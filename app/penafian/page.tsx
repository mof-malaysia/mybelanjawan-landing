      ...
      <div className="space-y-6 justify-center min-h-80 p-24 px-24">
        <div className="space-y-12">
          <div className="flex">
            ...
            <p>
              Kerajaan Malaysia dan Kementerian Kewangan tidak
              bertanggungjawab di atas kehilangan atau kerosakan disebabkan
              penggunaan mana-mana maklumat yang diperolehi daripada
              aplikasi ini.
            </p>
          </div>
          <div className="flex">
            ...
            <p>
              ...
              pengiklanan, pemasaran dan penjualan produk dan perkhidmatan
              serta menyebarkan maklumat tanpa kebenaran.
            </p>
          </div>
        </div>
      </div>
